 ...
 *
 * NOTE : NTS Aug25, 2015. The above formula has been translated into the below
 * code by simply factoring the polynomial into its horner representation
...
static __inline__ sll _sllexp(sll x)
{
	...
	// NOTE, NTS Aug25, 2015 the original version forgot to add the
	// LAST multiplication, which is the one immediately below, and
	// hence was considerably off.
